...
export default function ProLayout() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="bg-slate-900 sticky top-0 z-20">
          <div className="max-w-lg mx-auto px-4 py-3 flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-slate-400 text-[10px]">Professional Portal</p>
            </div>
            <button
              onClick={() => navigate('/')}
      ...
      <nav
        className="fixed bottom-0 inset-x-0 z-50 bg-slate-900 border-t border-slate-800"
        ...
        <div className="max-w-lg mx-auto flex">
          {NAV.map(({ icon: Icon, label, to, exact }) => {
            ...
            return (
              ...
              >
                <div className={`p-1.5 rounded-xl ${active ? 'bg-blue-500/20' : ''}`}>
